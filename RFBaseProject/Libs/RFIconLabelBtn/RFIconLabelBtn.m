...
@interface RFIconLabelBtn()
@property (nonatomic, strong) UIView *backgroudView;
@end

@implementation RFIconLabelBtn

- (id)initWithFrame:(CGRect)frame type:(RFIconLabelBtnType)type imageSize:(CGSize)imageSize midmargin:(CGFloat)midmargin{
    if (self = [super initWithFrame:frame]) {
        ...
        if (type == RFIconLabelBtnLeftImageType) {
        ...
        if (type == RFIconLabelBtnTopImageType) {
        ...
        if (type == RFIconLabelBtnRightImageType) {
...
- (void)touchAction:(void (^)(RFIconLabelBtn * _Nonnull))block{
